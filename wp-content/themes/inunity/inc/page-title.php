<div class="page-title group">
	<div class="page-title-inner group">
		...
		<?php if ( is_home() ) : ?>
			<h2><?php echo inunity_blog_title(); ?></h2>
		...
		<?php elseif ( is_search() ): ?>
			...
			<div class="notebox">
				<?php esc_html_e('For the term','inunity'); ?> "<span><?php echo get_search_query(); ?></span>".
				<?php if ( !have_posts() ): ?>
		...
		<?php elseif ( is_404() ): ?>
			<h1><i class="fas fa-exclamation-circle"></i><?php esc_html_e('Error 404.','inunity'); ?> <span><?php esc_html_e('Page not found!','inunity'); ?></span></h1>
			<div class="notebox">	
				<p><?php esc_html_e( 'The page you are trying to reach does not exist, or has been moved. Please use the menus or the search box to find what you are looking for.', 'inunity' ); ?></p>
				<?php get_search_form(); ?>
			</div>
