<div style="max-width: 560px;padding: 20px;background: #ffffff;border-radius: 5px;margin:40px auto;font-family: Open Sans,Helvetica,Arial;font-size: 15px;color: #666">
	...
	<div style="padding: 0 30px 30px 30px;border-bottom: 3px solid #eeeeee">
		...
		<div style="padding: 15px;background: #eee;border-radius: 3px;text-align: center">If you did not make this change and believe your account has been compromised, please <a href="{admin_email}" style="color: #3ba1da;text-decoration: none">contact  us</a> ASAP.</div>
